...
//                    float mStart = helperList.get(i).getStart();
    ...
    private void drawBackground(Canvas canvas){
        for(int i=0; i<5; i++){
            tempPoint.set(pieCenterPoint.x-(int)(Math.sin(Math.PI / 5 * i)*(pieRadius+lineLength)),
                    pieCenterPoint.y-(int)(Math.cos(Math.PI / 5 * i)*(pieRadius+lineLength)));
            tempPointRight.set(
                    pieCenterPoint.x+(int)(Math.sin(Math.PI / 5 * i)*(pieRadius+lineLength)),
                    pieCenterPoint.y+(int)(Math.cos(Math.PI / 5 * i)*(pieRadius+lineLength)));
        ...
        canvas.drawText("5",pieCenterPoint.x,mViewHeight,textPaint);
        canvas.drawText("7.5",leftTextWidth/2,
                pieCenterPoint.y+textRect.height()/2,textPaint);
        canvas.drawText("2.5",mViewWidth-rightTextWidth/2,
                pieCenterPoint.y+textRect.height()/2,textPaint);
    }
